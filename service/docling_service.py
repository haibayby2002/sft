...
# === Change this path to your sample PDF for manual test ===
PDF_PATH = "C:\\Users\\dell\\Downloads\\Module 1 Transcript - Blockchains, Tokens, and The Decentralized Future.pdf"
...
def extract_and_store_pdf_content(slide_id: int, pdf_path: str):
    ...
    for page in pages:
        ...
        # Insert page using the model
        page_obj = Page.insert(slide_id=slide_id, page_number=page_number)

        # Insert content using the model
        Content.insert(
